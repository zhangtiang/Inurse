...
public class DianzichenActivity extends FragmentActivity {

	public GlobalVar appState;
	
	public android.support.v4.app.FragmentTransaction ft;
	public FragmentDianzichen fragmentDianzichen;
...
//		initViewPager();
		...
		fragmentDianzichen = (FragmentDianzichen) fm.findFragmentById(R.layout.fragment_themometer);
		
		ft.add(R.id.frag_container,new FragmentDianzichen(), "home");
...
//				viewPager.setCurrentItem(0);
				replaceFrag(new FragmentDianzichen() );
				iv_celianghome.setBackgroundResource(R.drawable.home1);
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_data.setBackgroundResource(R.drawable.data);
				iv_celianghelp.setBackgroundResource(R.drawable.help);
